  ...
  return (
    <div className="min-h-screen pt-20 sm:pt-32 pb-10 sm:pb-20 bg-slate-50">
      <div className="max-w-3xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        {error && (
          <div className="mb-8 bg-red-50 border-l-4 border-red-500 p-6 rounded-2xl animate-fade-in flex items-center justify-between">
            <div className="flex items-center">
              ...
              <p className="text-red-700 font-bold text-sm sm:text-base">Gagal mengirim lamaran. Silakan coba lagi nanti.</p>
            </div>
            <button 
