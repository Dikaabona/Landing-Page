  ...
  return (
    <div className="min-h-screen pt-20 sm:pt-32 pb-10 sm:pb-20 bg-slate-50">
      <div className="max-w-3xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        {error && (
          <div className="mb-8 bg-white border-2 border-red-100 rounded-3xl overflow-hidden shadow-xl">
            <div className="bg-red-500 p-4 text-white">
              <p className="font-black flex items-center justify-center gap-2">
                <CheckCircle2 size={20} className="rotate-180" /> GAGAL MENGIRIM LAMARAN
              </p>
            </div>
            ...
            <div className="p-6 sm:p-10 space-y-8">
              <div className="bg-red-50 p-6 rounded-2xl border-l-4 border-red-500">
                ...
                <div className="space-y-4">
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Kami mencoba menyimpan data ke 2 tempat (Database Supabase & Google Sheets). Keduanya gagal merespon dengan benar. 
                  </p>
                </div>
              </div>
              ...
              <div>
                <h3 className="text-lg font-black text-slate-900 mb-4 flex items-center gap-2">
                  <div className="w-8 h-8 bg-emerald-100 rounded-lg flex items-center justify-center text-emerald-600">1</div>
                  Perbaikan via Supabase (SQL)
                </h3>
                <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mb-4">Langkah: Buka Supabase Dashboard {'>'} SQL Editor {'>'} Tempel kode di bawah {'>'} Run.</p>
                <pre className="bg-slate-900 text-slate-100 p-6 rounded-2xl text-[10px] sm:text-xs overflow-x-auto leading-relaxed shadow-inner border-2 border-slate-800">
...
-- 2. Aktifkan RLS (Keamanan)
ALTER TABLE public.careers ENABLE ROW LEVEL SECURITY;

-- 3. Izinkan Public Insert
...
-- 4. Izinkan Public Read untuk Tabel Articles
...
`}
              ...
              <div className="pt-6 border-t border-slate-100">
                <h3 className="text-lg font-black text-slate-900 mb-4 flex items-center gap-2">
                  <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center text-blue-600">2</div>
                  Perbaikan via Google Sheets
                </h3>
                <div className="bg-blue-50 p-6 rounded-2xl border-l-4 border-blue-500">
                  <ol className="list-decimal list-inside space-y-3 text-slate-700 text-sm font-medium">
                    <li>Buka Spreadsheet Anda yang ingin dijadikan database.</li>
                    <li>Pilih menu <strong className="text-blue-700 underline decoration-blue-200">Extensions {">"} Apps Script</strong>.</li>
                    <li>Salin kode skrip dari file <code className="bg-white px-2 py-0.5 rounded border border-blue-200 text-blue-800">GOOGLESCRIPT.md</code> di editor project ini.</li>
                    <li>Klik <strong className="text-blue-700">Deploy {">"} New Deployment</strong>.</li>
                    <li>Pilih <strong className="text-blue-700">Web App</strong>, set "Who has access" ke <strong className="text-red-500">Anyone</strong>.</li>
                    <li>Salin URL Web App dan masukkan ke Environment Variable <code className="bg-white px-2 py-0.5 rounded border border-blue-200">CAREER_SPREADSHEET_WEBHOOK_URL</code> di platform AI Studio.</li>
                  </ol>
                </div>
              </div>
              ...
              <div className="pt-6 text-center">
                <button 
                  ...
                  className="bg-slate-100 text-slate-600 px-8 py-3 rounded-xl font-bold hover:bg-slate-200 transition-all text-xs"
                >
                  Tutup Panduan & Coba Kirim Lagi
                </button>
              </div>
            </div>
          </div>
